  ...
  const renderStatusContent = () => {
      ...
      return (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-2">
            Your payment for order #{orderDetails.order_id} has been successfully processed.
          </p>
    ...
    if (status === "FAILED" || status === "CANCELLED") {
      return (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-8">
            Your payment for order #{orderDetails.order_id} could not be processed.
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 mb-8">
          We're still verifying your payment for order #{orderDetails.order_id}.
          You'll be notified once the status is confirmed.
        </p>
        <div className="flex justify-center space-x-4">
          <Link
            href="/"
