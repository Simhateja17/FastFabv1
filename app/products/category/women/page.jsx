...
export default function WomenProductsPage() {
  ...
  const fetchProducts = useCallback(async (locationData) => {
    try {
      ...
      console.log(`Fetching women's products within 3km of [${locationData.latitude}, ${locationData.longitude}]`);
      ...
      if (data.isLocationFilter) {
        console.log(`Location-filtered products: ${data.products.length} women's products within 3km radius`);
      }
            ...
            {loading || locationLoading ? (
              ...
              <div className="text-center py-12 bg-white rounded-lg shadow-sm mt-6">
                ...
                <p className="mt-2 text-gray-500">
                  {userLocation 
                    ? "No women's products found within 3km of your location. Try changing your location."
