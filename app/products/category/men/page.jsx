    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center text-sm mb-6">
          ...
          <span className="text-gray-900 font-medium">Men&apos;s Collection</span>
        </nav>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-8 border-b border-gray-200 pb-4">
              <h1 className="text-xl md:text-2xl font-bold text-gray-900">Men&apos;s Collection</h1>
              <p className="text-gray-500 mt-1">Browse our latest men&apos;s fashion</p>
            </div>
